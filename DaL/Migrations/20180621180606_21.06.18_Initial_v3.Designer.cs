...
namespace DaL.Migrations
{
    ...
    [Migration("20180621180606_21.06.18_Initial_v3")]
    partial class _210618_Initial_v3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.Models.UserModel", b =>
                {
                    ...
                    b.HasIndex("GroupManagerId")
                        .IsUnique()
                        .HasFilter("[GroupManagerId] IS NOT NULL");
            ...
            modelBuilder.Entity("Core.Models.Models.UserWorkTimeDataModel", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36);
            ...
            modelBuilder.Entity("Core.Models.Models.UserModel", b =>
                {
                    b.HasOne("Core.Models.Models.GroupModel", "GroupManager")
                        .WithOne("Manager")
                        .HasForeignKey("Core.Models.Models.UserModel", "GroupManagerId")
